...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/cus/cusData/">自定义单表列表</a></li>
		<li class="active"><a href="${ctx}/cus/cusData/form?id=${cusData.id}">自定义单表<shiro:hasPermission name="cus:cusData:edit">${not empty cusData.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cus:cusData:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="cusData" action="${ctx}/cus/cusData/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="inDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${cusData.inDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="form-actions">
			<shiro:hasPermission name="cus:cusData:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
